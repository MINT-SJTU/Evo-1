...
from scripts.miravla import MiraVLA
...
if __name__ == "__main__":
    ...
    #For example: ckpt_dir = "/home/dell/checkpoints/Evo1_700m/evo1_metaworld/step_65000/"

    port = 9000

    print("Loading Miravla model...")
    model, normalizer = load_model_and_normalizer(ckpt_dir)

    async def main():
        print(f"Miravla JSON server running at ws://0.0.0.0:{port}")
